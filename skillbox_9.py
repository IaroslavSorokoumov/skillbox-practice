...
low_temprt = 0
high_temprt = 100
temprt = int(input('Введите новое иземренное значение температуры воды: '))

if low_temprt <= temprt and high_temprt >= temprt:
  print('Температура воды в разрешённом диапазоне')
else:
  print('Температура воды в опасном диапазоне!')
